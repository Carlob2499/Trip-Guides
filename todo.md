# Repository Brief TODO

- [ ] Read `/home/ubuntu/upload/Pasted_content.txt` in full and extract every repository-wide requirement.
- [ ] Read the repository-wide operating instructions and relevant skill authorities before implementation.
- [ ] Convert every extracted requirement into a code-verifiable Trip-Guides task with explicit acceptance criteria.
- [ ] Implement the governing brief across Trip-Guides only; make no further Wayfinder preview changes under this mandate.
- [ ] Validate the repository with its documented tests, build, and any brief-specific quality gates.
- [ ] Record compliance, deliberate exclusions, and unresolved blockers in repository documentation.
