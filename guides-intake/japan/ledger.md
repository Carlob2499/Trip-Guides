...
> Research state for this guide: reconciliation, amendments, candidates, traveler questions,
> critic findings and sweep records. The traveler's own intent lives beside this in
> `intake.md` and is frozen after scaffold — never edit it from here.
