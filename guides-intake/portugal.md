...
## 1. The Traveler(s)
- **Who is this for / party:** the Korea group (3 mid-20s, heavy walkers)  *(→ pick the TRAVELER_PATTERNS party A/B/new before researching; do NOT infer from the last guide)*
- Number of travelers: 2
- Group makeup / ages / mobility / dietary (from Comments): one vegetarian
- First time or returning:
- Languages spoken:
- Home country (drives visa & entry research):

## 2. Trip Shape
- Exact dates (start–end): 2026-07-08 – 2026-07-14
- Cities: Lisbon, Porto
- Number of nights / cities:
- **Anchor event (the non-negotiable the trip is built around):** NOS Alive festival — Lisbon, Jul 9-11 2026 (nosalive.com)  *(VERIFY this first, against a T0 source — dates + venue — before any other research)*
...
## 4. Budget Reality
- Per-day target (from form): Mid-range ($75–150/day)
