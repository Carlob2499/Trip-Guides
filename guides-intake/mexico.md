...
## 1. The Traveler(s)
- **Who is this for / party:** a new pair  *(→ pick the TRAVELER_PATTERNS party A/B/new before researching; do NOT infer from the last guide)*
- Number of travelers: 2
- Group makeup / ages / mobility / dietary (from Comments): 
- First time or returning:
- Languages spoken:
- Home country (drives visa & entry research):

## 2. Trip Shape
- Exact dates (start–end): 2026-11-05 – 2026-11-09
- Cities: Mexico City
- Number of nights / cities:
- **Anchor event (the non-negotiable the trip is built around):** Pokemon GO Wild Area — CDMX Nov 6-8  *(VERIFY this first, against a T0 source — dates + venue — before any other research)*
