...
| Taimenseki | Shortlisted as an unverified backup (no evidence record) | Independently fetched hours/location/phone from a tourism-portal reference page | ADOPT — upgraded to shipped; added to Food & shopping and Day 2 as a casual/quick stop near Yamadera Station | B-only find, already T0-adjacent-verified — not a group-booked meal |
