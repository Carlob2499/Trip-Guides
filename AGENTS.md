...
Stacks on the global `~/.Codex/AGENTS.md` (universal accuracy rules — auto-loads
...
Enable **github** + **Codex Remote** only (verified 2026-07-22: nothing else has a call
...
- **Don't re-Read the AGENTS.md files** — both auto-load at session start; a Read on
  either is wasted. Phrase any "read AGENTS.md first" prompt as "already loaded".
