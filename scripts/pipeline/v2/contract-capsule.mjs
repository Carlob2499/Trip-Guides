...
function commonEvidenceSections({ slug, runId }) {
  ...
  return [
    ...
    "A search preview referencing an official page is never \"verified against the official source\"; never",
    "repair that defect by relabeling the same unsupported record blocked/fetched.",
