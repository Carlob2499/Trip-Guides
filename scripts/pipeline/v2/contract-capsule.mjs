...
function commonEvidenceSections({ slug, runId }) {
  ...
  return [
    ...
    "qualifying proof: only `fetched` means the origin was actually read. A search preview referencing an",
    "official page is never \"verified against the official source\"; never repair that defect by relabeling",
    "the preview as blocked/fetched while leaving the unsupported claim presented as verified.",
