...
// Not exported — nothing outside this file needs the raw table; go through
// accentFor() below, which is the actual public API for country → colour.
