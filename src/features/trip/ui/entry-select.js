/* Entry-requirements country picker (docs/archive/INDEX.md → FEATURES #7) — when a guide's entry[] carries
   ...
   (GuideDestination.astro only renders one when entry.length > 1). */
