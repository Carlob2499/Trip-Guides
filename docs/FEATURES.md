...
| 7 | **Entry-requirements card** | Visa/ETA + passport-validity for the party's home country — pipeline-researched, source+date stamped, recert-refreshed | Panel convention in Plan (+ **Trip kit** echo); intake home-country drives it | The pipeline-as-backend exemplar. NEVER a paid visa API. NEXT. |
