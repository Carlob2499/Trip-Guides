...
## Dashboard — August 31, 2026

- **Current phase:** Fukuoka remains the failed historical final-acceptance attempt, and its post-failure deterministic/model-input remediation remains merged. PR #149 later changed shared protected-main landing/control-plane behavior after Kumamoto r2's accepted base, making r2 preserved stale evidence only. A **fresh rebuilt Kumamoto release-readiness acceptance candidate is PRE-FLIGHT GREEN** on frozen r3 head `56e513000792bc71bf4e18c0a0909724fe5cebac`, based on repaired main `57e320535d1cb6e861a5001f8c26cc718dcfd93d`. No model-backed Kumamoto workflow has been dispatched yet.
- **Acceptance authority:** Fukuoka accepted base `6fdae06af63e3890d7e147e13e08af056bb150b6`; dispatch branch SHA `0a52ea1eb423f2d942b690942c3e9b62265b3c43`; Actions #59–#65. There were five manual resumes after the initial dispatch and one system auto-retry. Two proven usage-limit interruptions were refunded availability failures, so seven workflow dispatches still terminate at 5/5 quality attempts. Current fresh-candidate dispatch authority is Kumamoto r3 only, subject to the Sep 2 fresh drift/firewall audit.
...
- **Kumamoto preflight:** r2 `621dd43238d18b2b918827a9dca2268cd6f28c56` remains preserved historical preflight evidence but is stale for dispatch after merged PR #149 changed protected-main landing/control-plane semantics. Rebuilt r3 `56e513000792bc71bf4e18c0a0909724fe5cebac` reuses the same pre-registered Kumamoto scenario on repaired main `57e320535d1cb6e861a5001f8c26cc718dcfd93d`; closed-unmerged PR #167 proved that exact frozen head GREEN with Required Gate `33368339507`, freeze-policy, CodeQL, Analyze (actions), and Analyze (javascript-typescript) PASS. No model-backed Kumamoto workflow has been dispatched.
...
- **Preservation rule:** do not repair-and-merge `research-v2/fukuoka` or continue it past its cap. Preserve both stale Kumamoto candidates `acceptance/v2-kumamoto-20260902` and `acceptance/v2-kumamoto-20260902-r2` as historical evidence; neither may be dispatched. Current dispatch authority is only frozen r3 `acceptance/v2-kumamoto-20260902-r3` at `56e513000792bc71bf4e18c0a0909724fe5cebac`, and only after the Sep 2 fresh control-plane/model-burn firewall audit remains clean. Temporary PR #171 automation may dispatch that exact candidate once and may later redispatch only a durably recorded `usage-limit` interruption; it does not alter runId/state, quality caps, auto-retry caps, frozen inputs, selector, publication, or canary-merge authority. Any deterministic defect discovered during the new run invalidates that run and requires a separately repaired/rebuilt candidate.
...
- **Days until September 20 feature freeze:** 20
- **Days until September 27 code freeze:** 27
- **Days until September 30 engineering complete:** 30
- **Highest-risk unfinished items:** one clean fresh post-remediation release-readiness run must still prove Reconcile → Critic → landing on frozen Kumamoto r3; final protected-main repository settings still require owner/tooling capability; the remaining U03 physical-device interaction spot check is a manual evidence gap, not planned ordinary engineering.
...
| A03 | **Fresh post-remediation release-readiness acceptance — Kumamoto** | Acceptance | Claude/Fable + Codex | Sep 2 | **READY FOR REVIEW — R3 PREFLIGHT GREEN; MODEL DISPATCH PENDING** | A02 | Frozen branch `acceptance/v2-kumamoto-20260902-r3` at `56e513000792bc71bf4e18c0a0909724fe5cebac`, based on repaired main `57e320535d1cb6e861a5001f8c26cc718dcfd93d`; closed-unmerged PR #167 exact-head Required Gate `33368339507`, freeze-policy, CodeQL and both concrete analyses PASS; r2 is preserved stale evidence only | Live model-backed Reconcile → Critic → landing proof not yet executed | On Sep 2, after fresh drift/firewall audit, dispatch exactly once from frozen r3 if still clean; never dispatch superseded candidates; no cap extension, artifact hand-edit, cutover, publication, or candidate mutation |
