...
- **Highest-risk unfinished items:** one brief physical-device interaction spot check for S04, production cutover/publication parity, then one separately authorized clean V2 acceptance canary. S01/S02/S03/S05/S06 are now deterministic/browser-proven; S04's automated portion is green.
