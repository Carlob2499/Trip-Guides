...
- **Highest-risk unfinished items:** release-readiness adjudication; production cutover/publication parity; adversarial invalid-state, mobile, offline/poor-network, accessibility, and source-blocking stabilization; then a separately authorized V2 acceptance canary only if those gates justify it.
