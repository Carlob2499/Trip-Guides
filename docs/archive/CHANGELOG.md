...
> **Archived 2026-08-14** (owner ruling): entries stop at 2026-07-16 and this file moved from
> the repo root into `docs/archive/` — the home for pre-August history. The Atlas hub
> migration, the R5 guide redesign and the evidence-first program that followed are recorded
> in `CONTEXT.md` (decisions) and the archive's plan docs instead.
