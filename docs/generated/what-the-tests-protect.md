...
- form controls are >=16px so iOS never zoom-traps  <sub>tests/visual/a11y.spec.ts:624</sub>
- every page passes an automated accessibility scan  <sub>tests/visual/a11y.spec.ts:679</sub>
- each guide uses its own readable accent colour, not another guide's  <sub>tests/visual/a11y.spec.ts:767</sub>
- what's-next banner is legible  <sub>tests/visual/a11y.spec.ts:801</sub>
- ⌁ with every sheet closed, nothing inside one is focusable  <sub>tests/visual/a11y.spec.ts:856</sub>
- ⌁ an open sheet traps focus, Escape closes it, and focus comes back to the opener  <sub>tests/visual/a11y.spec.ts:875</sub>
- every visible target clears 44px — …, …  <sub>tests/visual/a11y.spec.ts:994</sub>
