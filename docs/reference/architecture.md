...
Published guides: **Sedona** (current) · **South Korea**, **Denmark** (`archived: true` —
concluded trips, kept as the historical record) · **Japan** (`draft: true` — mid-pipeline,
hidden from the hub grid and search index until it graduates).
