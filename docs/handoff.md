...
#130 is PARTIAL: `main` is protected by active `Main Protection` PR/non-fast-forward rules with no bypass, but the four required checks, fresh-integration enforcement, deletion protection, and live proof are still missing. No broad Actions bypass.
