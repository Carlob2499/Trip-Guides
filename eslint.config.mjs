...
export default tseslint.config(
     ...
     That bit here first: the four [slug] endpoints stayed red until they were rewritten. */
  {
    files: [
      ...
      "src/components/GuideDestination.astro",
      "src/components/ItineraryDestination.astro",
      "src/components/Learnings.astro",
      "src/components/TripDestination.astro",
      ...
      "src/features/trip/model/arrival.ts",
      "src/features/trip/model/book-by.ts",
      "src/features/trip-split/model/records.ts",
      "src/layouts/GuideLayout.astro",
      "src/lib/guide-view.ts",
